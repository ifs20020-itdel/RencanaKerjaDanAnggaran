...
@section('title', 'Operasional Kemahasiswaan')
@section('breadcrumb1')
    <li class="breadcrumb-item"><a href="/biayaOperasionalPendidikan">Operasional Kemahasiswaan</a></li>
@endsection
@section('breadcrumb2')
    <li class="breadcrumb-item">Create</li>
@endsection

@section('judul', '2. Biaya Operational Kemahasiswaan')
        ...
        <form action="/kemahasiswaan" method="POST">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="mataAnggaran" class="form-control" placeholder="Cth. II.2.1" value="{{old('mataAnggaran')}}">
