...
<html lang="en">
  ...
  <head>
    ...
    <title>11S20020 - Roosen Gabriel Manurung</title>
    ...
    <link rel="icon" href="{{asset("layout/dist/img/del.ico")}}" type="image/x-icon">
    @stack('style')
  ...
  <body class="hold-transition sidebar-mini">
    ...
    @include('partial.sidebar')
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2022 Roosen G.M.</a></strong>
      </footer>
