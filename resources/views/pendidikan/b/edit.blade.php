...
@section('title')
    {{$gajiTenagaKependidikan->mataAnggaran}}
@endsection
...
@endsection
@section('breadcrumb2')
    <li class="breadcrumb-item">{{$gajiTenagaKependidikan->mataAnggaran}} / Edit</li>
@endsection

@section('judul')
Halaman Edit Data: &nbsp; {{$gajiTenagaKependidikan->mataAnggaran}} - {{$gajiTenagaKependidikan->namaAnggaran}}
@endsection
...
<div class="col-lg-7 col-6">
    <div class="card card-dark">
        ...
        <form action="/biayaOperasionalPendidikan/{{$gajiTenagaKependidikan->id}}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="mataAnggaran" class="form-control" value="{{$gajiTenagaKependidikan->mataAnggaran}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="namaAnggaran" class="form-control" value="{{$gajiTenagaKependidikan->namaAnggaran}}">
